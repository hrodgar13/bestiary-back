...
import {
    CreateAlignmentDto,
    CreateArmorDto, CreateDamageTypeDto,
    CreateFeelNameDto,
    CreateLanguageDto,
    CreateSavingThrowDto,
    CreateSizeDto, CreateSkillDto, CreateSpeedTypeDto, CreateStatementDto, CreateTypeDto
...
export class ArmorClassController extends BasicController<ArmorClass, CreateArmorDto> {
    constructor(
        private readonly additionalService: AdditionService,
        @InjectRepository(ArmorClass) private readonly armorRepository: Repository<ArmorClass>
    ) {
...
@Controller('language')
export class LanguageController extends BasicController<Language, CreateLanguageDto> {
    constructor(
        private readonly additionalService: AdditionService,
...
export class SavingThrowController extends BasicController<SavingThrow, CreateSavingThrowDto> {
    constructor(
        private readonly additionalService: AdditionService,
        @InjectRepository(SavingThrow) private readonly savingThrowRepository: Repository<SavingThrow>
    ) {
...
@Controller('speed')
export class SpeedController extends BasicController<Speed, CreateSpeedTypeDto> {
    constructor(
        private readonly additionalService: AdditionService,
        @InjectRepository(Speed) private readonly speedRepository: Repository<Speed>
    ) {
...
export class StatementController extends BasicController<Statement, CreateStatementDto> {
    constructor(
        private readonly additionalService: AdditionService,
...
export class DamageTypeController extends BasicController<DamageType, CreateDamageTypeDto> {
    constructor(
        private readonly additionalService: AdditionService,
        @InjectRepository(DamageType) private readonly damageTypeRepository: Repository<DamageType>
    ) {
...
export class AlignmentController extends BasicController<Aligment, CreateAlignmentDto> {
    constructor(
        private readonly additionalService: AdditionService,
        @InjectRepository(Aligment) private readonly alignmentRepository: Repository<Aligment>
    ) {
